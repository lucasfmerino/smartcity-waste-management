ALTER SYSTEM SET spring.datasource.url = 'jdbc:oracle:thin:@localhost:1521:xe';
ALTER SYSTEM SET spring.datasource.username = 'RM550690';
ALTER SYSTEM SET spring.datasource.password = '090405';
